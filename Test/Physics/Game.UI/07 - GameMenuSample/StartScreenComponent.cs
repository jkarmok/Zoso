    ...
    public override void Update(GameTime gameTime)
    {
      ...
      else
      {
        if (_uiScreen.UIService == null)
        {
          ...
          // Keep the content manager around. (Its lifetime is bound to the service container.
          // The service container is disposed when the sample ends.)
          var serviceContainer = (ServiceContainer)_services;
          serviceContainer.Register(typeof(ContentManager), "SampleUIContent", _uiContentManager);
        }
