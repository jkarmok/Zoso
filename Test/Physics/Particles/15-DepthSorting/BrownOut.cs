...
namespace DigitalRune.Samples.Particles
{
  public class BrownOut : ParticleSystem
  {
    ...
    public BrownOut(ContentManager contentManager)
    {
      ...
      // Smoke on a ring.
      var outterRingSmoke = CreateSmoke(contentManager);
      outterRingSmoke.Effectors.Add(new StreamEmitter { DefaultEmissionRate = 30 });
      outterRingSmoke.Effectors.Add(new StartPositionEffector
      {
      ...
      Children = new ParticleSystemCollection { outterRingSmoke, innerCircleSmoke };
    }
