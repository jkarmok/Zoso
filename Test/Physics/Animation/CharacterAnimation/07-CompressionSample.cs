...
visually compare the compression results.",
  ...
  public class CompressionSample : CharacterAnimationSample
  {
    ...
    protected override void Dispose(bool disposing)
    {
      ...
      {
        // Clean up.
        GraphicsScreen.Scene.Children.Remove(_meshNodeUncompressed);
        _meshNodeUncompressed.Dispose(false);

        GraphicsScreen.Scene.Children.Remove(_meshNodeCompressed);
        _meshNodeCompressed.Dispose(false);
      }
