...
bone name, bone indices and bone coordinate systems.",
  ...
  public class BindPoseSample : CharacterAnimationSample
  {
    ...
    protected override void Dispose(bool disposing)
    {
      ...
      {
        // Clean up.
        GraphicsScreen.Scene.Children.Remove(_dudeMeshNode);
        _dudeMeshNode.Dispose(false);

        GraphicsScreen.Scene.Children.Remove(_marineMeshNode);
        _marineMeshNode.Dispose(false);
      }
