...
namespace DigitalRune.Samples.Physics.Specialized
{
  ...
  public class CharacterControllerObject : GameObject
  {
    ...
    private void ToggleHulk()
    {
      ...
      // Only the KinmaticCharacterController has a PushForce property. The push force of the 
    ...
    private bool HasLedgeContact()
    {
      ...
      // collisons in the top part of the character and a second time on a lower positions.
