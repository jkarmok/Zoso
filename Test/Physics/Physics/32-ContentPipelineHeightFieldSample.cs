...
namespace DigitalRune.Samples.Physics
{
  [Sample(SampleCategory.Physics,
    "Loads a height field was generated in the XNA content pipeline.",
    "",
    32)]
  public class ContentPipelineHeightFieldSample : PhysicsSample
  {
    // This sample uses the HeightFieldProcessor (see project "DigitalRune.Samples.Content.Pipeline"). 
