...
When viewed from the viewpoint of the moving camera, frustum culling should provide a noticable 
performance improvement. (Hold <F4> to show/reset profiling data.)",
  ...
  public class FrustumCullingSample : BasicSample
  {
    ...
    private bool _topViewEnabled = true;   // True for bird's-eye view. False for camera view.
