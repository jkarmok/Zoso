...
{
	public class LoginCharacter : GameOperation
	{
		/// <summary>
		...
		public override byte OperationCode
		{
			get
			{
				return (byte) GameOperationCode.LoginCharacter;
			}
		}

		public LoginCharacter(IRpcProtocol protocol, GameOperationRequest request)
