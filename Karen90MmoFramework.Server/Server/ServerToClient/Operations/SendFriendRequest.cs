...
{
	public class SendFriendRequest : GameOperation
	{
		/// <summary>
		...
		{
			get { return (byte)GameOperationCode.SendFriendRequest; }
		}

		public SendFriendRequest(IRpcProtocol protocol, GameOperationRequest request)
