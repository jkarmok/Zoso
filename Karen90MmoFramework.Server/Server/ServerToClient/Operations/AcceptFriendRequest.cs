...
{
	public class AcceptFriendRequest : GameOperation
	{
		/// <summary>
		...
		public override byte OperationCode
		{
			get
			{
				return (byte) GameOperationCode.AcceptFriendRequest;
			}
		}

		public AcceptFriendRequest(IRpcProtocol protocol, GameOperationRequest request)
