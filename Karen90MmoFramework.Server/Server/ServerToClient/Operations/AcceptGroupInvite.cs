...
{
	public class AcceptGroupInvite : GameOperation
	{
		/// <summary>
		...
		public override byte OperationCode
		{
			get
			{
				return (byte) GameOperationCode.AcceptGroupInvite;
			}
		}

		public AcceptGroupInvite(IRpcProtocol protocol, GameOperationRequest request)
