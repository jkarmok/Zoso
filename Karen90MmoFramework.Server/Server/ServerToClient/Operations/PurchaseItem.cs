...
{
	public class PurchaseItem : GameOperation
	{
		/// <summary>
		...
		public override byte OperationCode
		{
			get
			{
				return (byte) GameOperationCode.PurchaseItem;
			}
		}

		public PurchaseItem(IRpcProtocol protocol, GameOperationRequest request)
