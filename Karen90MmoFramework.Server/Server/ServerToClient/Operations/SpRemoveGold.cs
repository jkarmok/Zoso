...
{
	public class SpRemoveGold : GameOperation
	{
		/// <summary>
		...
		public override byte OperationCode
		{
			get
			{
				return (byte) GameOperationCode.SpRemoveGold;
			}
		}

		public SpRemoveGold(IRpcProtocol protocol, GameOperationRequest request)
