...
{
	public class SocialServerPeer : OutgoingMasterServerPeer, ISocialServer
	{
		...
		#region Implementation of ISocialServerPeer

		/// <summary>
		/// Gets the character database
		/// </summary>
		DatabaseFactory ISocialServer.CharacterDatabase
		{
			get
			{
		...
		/// </summary>
		IChatManager ISocialServer.ChatManager
		{
			get
			{
		...
		/// Kills a session
		/// </summary>
		void ISocialServer.KillSession(int sessionId)
		{
			this.SendOperationRequest(
